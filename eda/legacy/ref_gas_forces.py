...
qmmm = QMMM(mode="text", driver="sander", cwd=Path("gas_forces__ARRAY__"))
...
np.save("gas_energy__ARRAY__", energy)
np.save("gas_forces__ARRAY__", forces)
np.save("gas_prot_forces__ARRAY__", prot_forces)
np.save("gas_near_forces__ARRAY__", near_forces)
np.save("gas_far_forces__ARRAY__", far_forces)
np.save("gas_mm_esp__ARRAY__", mm_esp_all)
