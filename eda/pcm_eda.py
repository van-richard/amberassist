...
work_dir = Path(os.environ.get("EDA_WORK_DIR", "eda/pcm_work"))
...
np.save(output_dir / "pcm_energy.npy", energy)
np.save(output_dir / "pcm_forces.npy", forces)
np.save(output_dir / "pcm_prot_forces.npy", prot_forces)
np.save(output_dir / "pcm_near_forces.npy", near_forces)
np.save(output_dir / "pcm_far_forces.npy", far_forces)
np.save(output_dir / "pcm_mm_esp.npy", mm_esp_all)
