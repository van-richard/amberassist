...
np.save(output_dir / 'lj_prot_forces.npy', prot_forces)
np.save(output_dir / 'lj_near_forces.npy', near_forces)
np.save(output_dir / 'lj_prot_forces_sum.npy', np.sum(prot_forces, axis=3))
