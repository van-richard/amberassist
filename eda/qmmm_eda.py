...
work_dir = Path(os.environ.get("EDA_WORK_DIR", "eda/qmmm_work"))
...
np.save(output_dir / "qmmm_energy.npy", energy)
np.save(output_dir / "qmmm_forces.npy", forces)
np.save(output_dir / "qmmm_prot_forces.npy", prot_forces)
np.save(output_dir / "qmmm_near_forces.npy", near_forces)
np.save(output_dir / "qmmm_far_forces.npy", far_forces)
np.save(output_dir / "qmmm_mm_esp.npy", mm_esp_all)
