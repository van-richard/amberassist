...
if __name__ == "__main__":
    ...
    qm_coord = np.load("qm_coord.npy")
    qm_element = np.loadtxt("qm_elem.txt", dtype=int)
    mm_coord = np.load("mm_coord.npy")
    mm_charge = np.load("mm_charge.npy")

    energy = np.load("energy.npy")
    qm_grad = np.load("qm_grad.npy")
    mm_esp = np.load("mm_esp.npy")
    mm_esp_grad = np.load("mm_esp_grad.npy")
